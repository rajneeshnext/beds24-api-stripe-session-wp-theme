            ...
            <td>
                ...
                <div style="padding:10px 0;border-bottom:1px solid #eee;">
                    ...
                    <div style="font-size:13px;color:#777;margin-top:4px;">
                        <?php pll_e("Booked on");?>: <?php echo date("D, M j, Y — H:i", strtotime($b["bookingTime"])); ?>
                    </div>
...
if (empty($_SESSION[$bookingKey])) {
    ...
    wp_mail(
		$customerEmail,
		pll__('Booking Confirmation – Your Stay'),
		$emailHTML,
		$headers
	);
